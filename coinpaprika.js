(async () => {
  ...
  exports.historical = async (
    id,
    start,
    params = { end: false, interval: "5m", quote: "USD", limit: 1000 }
  ) => {
    params.start = start;
  ...
  exports.search = async (
    query = "btc",
    params = { limit: 6, c: "currencies,exchanges,icos,people,tags" }
  ) => {
    params.q = query;
  ...
  exports.candles = async (
    id,
    start,
    params = { end: false, quote: "USD", limit: 366 }
  ) => {
    params.start = start;
    if (typeof params.end == "undefined" || !params.end)
      params.end = new Date().toISOString();
  ...
  exports.depth = async (
    ...
    return request(
      `https://coinpaprika.com/ajax/transparency/markets-depth/${id}/${currency}/`,
      params
    );
  };
  ...
  exports.mcap = async (timeframe = "24h", params = {}) => {
    return request(
      `https://coinpaprika.com/overview/data/total/${timeframe}/`,
      params
    );
  };
  ...
  exports.altcap = async (timeframe = "24h", params = {}) => {
    return request(
      `https://coinpaprika.com/overview/data/totalExclude/${timeframe}/`,
      params
    );
  };
})();
